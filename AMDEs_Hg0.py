...
Met_V1_17_HM['WD_Avg']   = Met_V1_17_HM[['wnd_dir_strbrd_corr_deg',               'wnd_dir_port_corr_deg']].mean(axis=1) # V1_17
Met_V2_17_HM['WD_Avg']   = Met_V2_17_HM[['wnd_dir_strbrd_corr_deg',               'wnd_dir_port_corr_deg']].mean(axis=1) # V2_17
Met_V3_17M_HM['WD_Avg']  = Met_V3_17M_HM[['wnd_dir_strbrd_corr_deg',              'wnd_dir_port_corr_deg']].mean(axis=1) # V3_17
Met_V3_17D_HM['WD_Avg']  = Met_V3_17D_HM[['wnd_dir_strbrd_corr_deg',              'wnd_dir_port_corr_deg']].mean(axis=1) # V3_17
Met_V4_17_HM['WD_Avg']   = Met_V4_17_HM[['wnd_dir_strbrd_corr_deg',               'wnd_dir_port_corr_deg']].mean(axis=1) # V4_17

Met_V1_18_HM['WD_Avg']   = Met_V1_18_HM[['wnd_dir_strbrd_corr_deg',               'wnd_dir_port_corr_deg']].mean(axis=1) # V1_18
Met_V2_18_HM['WD_Avg']   = Met_V2_18_HM[['wnd_dir_strbrd_corr_deg',               'wnd_dir_port_corr_deg']].mean(axis=1) # V2_18
Met_V3_18M_HM['WD_Avg']  = Met_V3_18M_HM[['wnd_dir_strbrd_corr_deg',              'wnd_dir_port_corr_deg']].mean(axis=1) # V3_18
Met_V3_18D_HM['WD_Avg']  = Met_V3_18D_HM[['wnd_dir_strbrd_corr_deg',              'wnd_dir_port_corr_deg']].mean(axis=1) # V3_18
Met_V4_18_HM['WD_Avg']   = Met_V4_18_HM[['wnd_dir_strbrd_corr_deg',               'wnd_dir_port_corr_deg']].mean(axis=1) # V4_18

Met_PCAN_HM['WD_Avg']    = Met_PCAN_HM[['Starboard True Wind Direction (degree)', 'Port True Wind Direction (degree)']].mean(axis=1) # PCAN
Met_SIPEXII_HM['WD_Avg'] = Met_SIPEXII_HM[['wnd_dir_strbrd_corr_deg',             'wnd_dir_port_corr_deg']].mean(axis=1) # SIPEXII

#------------------------------------------------------------------------------
# PLOT THE GRAPH (AMDE 1 16-19 Nov 2017)
fig = plt.figure()
...
plt.xlim(datetime(2017,11,15,0,1,),datetime(2017,11,20,23,59,0))
...
#ax1.plot(Met_V1_17_HM.index,    Met_V1_17_HM['RH_Avg'],    marker='o',    markersize=1.0,   ls='--',  c='blue', zorder=2)

# Temp
ax2.scatter(Met_V1_17_HM.index, Met_V1_17_HM['Temp_Avg'], marker='o', s= 1.0, c='red',  zorder=2)
#ax2.plot(Met_V1_17_HM.index,    Met_V1_17_HM['Temp_Avg'],    marker='o',    markersize=1.0,   ls='--',  c='red',  zorder=2)

# Wind Dir
ax3.scatter(Met_V1_17_HM.index, Met_V1_17_HM['WD_Avg'], marker='o', s= 1.0, c='orange',  zorder=2)
#ax3.plot(Met_V1_17_HM.index,    Met_V1_17_HM['WD_Avg'],    marker='o',    markersize=1.0,   ls='--',  c='orange',  zorder=2)
...
# Format y-axis 3 (Wind Dir)
ax3.yaxis.set_major_locator(ticker.MultipleLocator(90))
ax3.yaxis.set_minor_locator(ticker.MultipleLocator(30))
ax3.spines["right"].set_position(("axes", 1.13))
ax3.tick_params(axis='y', which='both', colors='orange', labelsize=10)
ax3.set_ylim(0,360)
...
ax3.set_ylabel('Wind Direction (($^\circ$))',fontsize=12)
...
# Wind Dir
ax6.scatter(Met_V1_17_HM.index, Met_V1_17_HM['WD_Avg'], marker='o', s= 1.0, c='orange',  zorder=2)
#ax6.plot(Met_V1_17_HM.index,    Met_V1_17_HM['WD_Avg'],    marker='o',    markersize=1.0,   ls='--',  c='orange',  zorder=2)
...
# Format y-axis 6 (Wind Dir)
ax6.yaxis.set_major_locator(ticker.MultipleLocator(90))
ax6.yaxis.set_minor_locator(ticker.MultipleLocator(30))
ax6.spines["right"].set_position(("axes", 1.13))
ax6.tick_params(axis='y', which='both', colors='orange', labelsize=10)
ax6.set_ylim(0,360)
ax6.spines["right"].set_color('orange')
...
ax6.set_ylabel('Wind Direction (($^\circ$))',fontsize=12)
...
#ax6.scatter(Met_V1_17_HM.index, Met_V1_17_HM['WD_Avg'], marker='o', s= 1.0, c='orange',  zorder=2)
#ax6.plot(Met_V1_17_HM.index,    Met_V1_17_HM['WD_Avg'],    marker='o',    markersize=1.0,   ls='--',  c='orange',  zorder=2)
ax6.scatter(Met_V1_17.index, Met_V1_17['wnd_dir_strbrd_corr_deg'], marker='o', s= 1.0, c='orange',  zorder=2)
