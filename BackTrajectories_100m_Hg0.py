...
while date <= end_date:
    ...
    filename = 'gdas1nov0100spring' + dateA
    date += delta_one_hour
...
while date <= end_date:
    dateA = date.strftime('%Y%m%d%H')
    filename = 'gdas1dec0100summer' + dateA
    date += delta_one_hour
    all_filenames.append(filename)
...
while date <= end_date:
    dateA = date.strftime('%Y%m%d%H')
    filename = 'gdas1jan0100summer' + dateA
    date += delta_one_hour
    all_filenames.append(filename)
...
while date <= end_date:
    dateA = date.strftime('%Y%m%d%H')
    filename = 'gdas1feb0100summer' + dateA
    date += delta_one_hour
    all_filenames.append(filename)
...
while date <= end_date:
    dateA = date.strftime('%Y%m%d%H')
    filename = 'gdas1mar0100autumn' + dateA
    date += delta_one_hour
    all_filenames.append(filename)
...
for f in all_filenames:
    ...
    file['Weighting']        = file['Traj Age'].values[::-1]*-1
    # Weighted Land, Ice and Ocean values
    file['Weighted_Ice']     = np.sum(file['Weighting']*file['Traj over Sea Ice?']/120)
    file['Weighted_Land']    = np.sum(file['Weighting']*file['Traj over Ice Sheet?']/120)
    file['Weighted_Ocean']   = np.sum(file['Weighting']*file['Traj over Ocean?']/120)
    # Set the Hg0 concentration at the corresponding datetime as a row
...
# Overall
All_1819    = Traj_V1_18.append(Traj_V2_18)
All_1819    = All_1819.append(Traj_V3_18M)
All_1819    = All_1819.append(Traj_V3_18D)

# Sea Ice
SeaIce_1819 = Traj_V1_18SI.append(Traj_V2_18SI)
SeaIce_1819 = SeaIce_1819.append(Traj_V3_18MSI)
SeaIce_1819 = SeaIce_1819.append(Traj_V3_18DSI)
#SeaIce_1819.to_csv('/Users/ncp532/Desktop/SeaIce_1819.csv')

# Land
Land_1819   = Traj_V1_18L.append(Traj_V2_18L)
Land_1819   = Land_1819.append(Traj_V3_18ML)
Land_1819   = Land_1819.append(Traj_V3_18DL)
#Land_1819.to_csv('/Users/ncp532/Desktop/Land_1819.csv')

# Ocean
Ocean_1819  = Traj_V1_18O.append(Traj_V2_18O)
Ocean_1819  = Ocean_1819.append(Traj_V3_18MO)
Ocean_1819  = Ocean_1819.append(Traj_V3_18DO)
...
# Overall
N_V1_18    = len(Traj_V1_18)
N_V2_18    = len(Traj_V2_18)
N_V3_18M   = len(Traj_V3_18M)
N_V3_18D   = len(Traj_V3_18D)

# Sea Ice
N_V1_18SI  = len(Traj_V1_18SI)
N_V2_18SI  = len(Traj_V2_18SI)
N_V3_18MSI = len(Traj_V3_18MSI)
N_V3_18DSI = len(Traj_V3_18DSI)

# Land
N_V1_18L   = len(Traj_V1_18L)
N_V2_18L   = len(Traj_V2_18L)
N_V3_18ML  = len(Traj_V3_18ML)
N_V3_18DL  = len(Traj_V3_18DL)

# Ocean
N_V1_18O   = len(Traj_V1_18O)
N_V2_18O   = len(Traj_V2_18O)
N_V3_18MO  = len(Traj_V3_18MO)
N_V3_18DO  = len(Traj_V3_18DO)
...
# Overall
Mean_V1_18    = np.mean(Traj_V1_18['ng/m3'])
Mean_V2_18    = np.mean(Traj_V2_18['ng/m3'])
Mean_V3_18M   = np.mean(Traj_V3_18M['ng/m3'])
Mean_V3_18D   = np.mean(Traj_V3_18D['ng/m3'])

# Sea Ice
Mean_V1_18SI  = np.mean(Traj_V1_18SI['ng/m3'])
Mean_V2_18SI  = np.mean(Traj_V2_18SI['ng/m3'])
Mean_V3_18MSI = np.mean(Traj_V3_18MSI['ng/m3'])
Mean_V3_18DSI = np.mean(Traj_V3_18DSI['ng/m3'])

# Land
Mean_V1_18L   = np.mean(Traj_V1_18L['ng/m3'])
Mean_V2_18L   = np.mean(Traj_V2_18L['ng/m3'])
Mean_V3_18ML  = np.mean(Traj_V3_18ML['ng/m3'])
Mean_V3_18DL  = np.mean(Traj_V3_18DL['ng/m3'])

# Ocean
Mean_V1_18O   = np.mean(Traj_V1_18O['ng/m3'])
Mean_V2_18O   = np.mean(Traj_V2_18O['ng/m3'])
Mean_V3_18MO  = np.mean(Traj_V3_18MO['ng/m3'])
Mean_V3_18DO  = np.mean(Traj_V3_18DO['ng/m3'])
...
# Overall
Median_V1_18    = np.median(Traj_V1_18['ng/m3'])
Median_V2_18    = np.median(Traj_V2_18['ng/m3'])
Median_V3_18M   = np.median(Traj_V3_18M['ng/m3'])
Median_V3_18D   = np.median(Traj_V3_18D['ng/m3'])

# Sea Ice
Median_V1_18SI  = np.median(Traj_V1_18SI['ng/m3'])
Median_V2_18SI  = np.median(Traj_V2_18SI['ng/m3'])
Median_V3_18MSI = np.median(Traj_V3_18MSI['ng/m3'])
Median_V3_18DSI = np.median(Traj_V3_18DSI['ng/m3'])

# Land
Median_V1_18L   = np.median(Traj_V1_18L['ng/m3'])
Median_V2_18L   = np.median(Traj_V2_18L['ng/m3'])
Median_V3_18ML  = np.median(Traj_V3_18ML['ng/m3'])
Median_V3_18DL  = np.median(Traj_V3_18DL['ng/m3'])

# Ocean
Median_V1_18O   = np.median(Traj_V1_18O['ng/m3'])
Median_V2_18O   = np.median(Traj_V2_18O['ng/m3'])
Median_V3_18MO  = np.median(Traj_V3_18MO['ng/m3'])
Median_V3_18DO  = np.median(Traj_V3_18DO['ng/m3'])
...
# Overall
std_V1_18    = np.std(Traj_V1_18['ng/m3'])
std_V2_18    = np.std(Traj_V2_18['ng/m3'])
std_V3_18M   = np.std(Traj_V3_18M['ng/m3'])
std_V3_18D   = np.std(Traj_V3_18D['ng/m3'])

# Sea Ice
std_V1_18SI  = np.std(Traj_V1_18SI['ng/m3'])
std_V2_18SI  = np.std(Traj_V2_18SI['ng/m3'])
std_V3_18MSI = np.std(Traj_V3_18MSI['ng/m3'])
std_V3_18DSI = np.std(Traj_V3_18DSI['ng/m3'])

# Land
std_V1_18L   = np.std(Traj_V1_18L['ng/m3'])
std_V2_18L   = np.std(Traj_V2_18L['ng/m3'])
std_V3_18ML  = np.std(Traj_V3_18ML['ng/m3'])
std_V3_18DL  = np.std(Traj_V3_18DL['ng/m3'])

# Ocean
std_V1_18O   = np.std(Traj_V1_18O['ng/m3'])
std_V2_18O   = np.std(Traj_V2_18O['ng/m3'])
std_V3_18MO  = np.std(Traj_V3_18MO['ng/m3'])
std_V3_18DO  = np.std(Traj_V3_18DO['ng/m3'])
...
# Overall
MAD_V1_18    = stats.median_absolute_deviation(Traj_V1_18['ng/m3'])
MAD_V2_18    = stats.median_absolute_deviation(Traj_V2_18['ng/m3'])
MAD_V3_18M   = stats.median_absolute_deviation(Traj_V3_18M['ng/m3'])
MAD_V3_18D   = stats.median_absolute_deviation(Traj_V3_18D['ng/m3'])

# Sea Ice
MAD_V1_18SI  = stats.median_absolute_deviation(Traj_V1_18SI['ng/m3'])
MAD_V2_18SI  = stats.median_absolute_deviation(Traj_V2_18SI['ng/m3'])
MAD_V3_18MSI = stats.median_absolute_deviation(Traj_V3_18MSI['ng/m3'])
MAD_V3_18DSI = stats.median_absolute_deviation(Traj_V3_18DSI['ng/m3'])

# Land
MAD_V1_18L   = stats.median_absolute_deviation(Traj_V1_18L['ng/m3'])
MAD_V2_18L   = stats.median_absolute_deviation(Traj_V2_18L['ng/m3'])
MAD_V3_18ML  = stats.median_absolute_deviation(Traj_V3_18ML['ng/m3'])
MAD_V3_18DL  = stats.median_absolute_deviation(Traj_V3_18DL['ng/m3'])

# Ocean
MAD_V1_18O   = stats.median_absolute_deviation(Traj_V1_18O['ng/m3'])
MAD_V2_18O   = stats.median_absolute_deviation(Traj_V2_18O['ng/m3'])
MAD_V3_18MO  = stats.median_absolute_deviation(Traj_V3_18MO['ng/m3'])
MAD_V3_18DO  = stats.median_absolute_deviation(Traj_V3_18DO['ng/m3'])
...
# Overall
Min_V1_18    = np.min(Traj_V1_18['ng/m3'])
Min_V2_18    = np.min(Traj_V2_18['ng/m3'])
Min_V3_18M   = np.min(Traj_V3_18M['ng/m3'])
Min_V3_18D   = np.min(Traj_V3_18D['ng/m3'])

# Sea Ice
Min_V1_18SI  = np.min(Traj_V1_18SI['ng/m3'])
Min_V2_18SI  = np.min(Traj_V2_18SI['ng/m3'])
Min_V3_18MSI = np.min(Traj_V3_18MSI['ng/m3'])
Min_V3_18DSI = np.min(Traj_V3_18DSI['ng/m3'])

# Land
Min_V1_18L   = np.min(Traj_V1_18L['ng/m3'])
Min_V2_18L   = np.min(Traj_V2_18L['ng/m3'])
Min_V3_18ML  = np.min(Traj_V3_18ML['ng/m3'])
Min_V3_18DL  = np.min(Traj_V3_18DL['ng/m3'])

# Ocean
Min_V1_18O   = np.min(Traj_V1_18O['ng/m3'])
Min_V2_18O   = np.min(Traj_V2_18O['ng/m3'])
Min_V3_18MO  = np.min(Traj_V3_18MO['ng/m3'])
Min_V3_18DO  = np.min(Traj_V3_18DO['ng/m3'])
...
# Overall
Max_V1_18    = np.max(Traj_V1_18['ng/m3'])
Max_V2_18    = np.max(Traj_V2_18['ng/m3'])
Max_V3_18M   = np.max(Traj_V3_18M['ng/m3'])
Max_V3_18D   = np.max(Traj_V3_18D['ng/m3'])

# Sea Ice
Max_V1_18SI  = np.max(Traj_V1_18SI['ng/m3'])
Max_V2_18SI  = np.max(Traj_V2_18SI['ng/m3'])
Max_V3_18MSI = np.max(Traj_V3_18MSI['ng/m3'])
Max_V3_18DSI = np.max(Traj_V3_18DSI['ng/m3'])

# Land
Max_V1_18L   = np.max(Traj_V1_18L['ng/m3'])
Max_V2_18L   = np.max(Traj_V2_18L['ng/m3'])
Max_V3_18ML  = np.max(Traj_V3_18ML['ng/m3'])
Max_V3_18DL  = np.max(Traj_V3_18DL['ng/m3'])

# Ocean
Max_V1_18O   = np.max(Traj_V1_18O['ng/m3'])
Max_V2_18O   = np.max(Traj_V2_18O['ng/m3'])
Max_V3_18MO  = np.max(Traj_V3_18MO['ng/m3'])
Max_V3_18DO  = np.max(Traj_V3_18DO['ng/m3'])
...
# Overall
P5_V1_18    = np.percentile(Traj_V1_18['ng/m3'],    5)
P5_V2_18    = np.percentile(Traj_V2_18['ng/m3'],    5)
P5_V3_18M   = np.percentile(Traj_V3_18M['ng/m3'],   5)
P5_V3_18D   = np.percentile(Traj_V3_18D['ng/m3'],   5)

# Sea Ice
P5_V1_18SI  = np.percentile(Traj_V1_18SI['ng/m3'],  5)
P5_V2_18SI  = np.percentile(Traj_V2_18SI['ng/m3'],  5)
P5_V3_18MSI = np.nan #np.percentile(Traj_V3_18MSI['ng/m3'], 5)
P5_V3_18DSI = np.percentile(Traj_V3_18DSI['ng/m3'], 5)

# Land
P5_V1_18L   = np.percentile(Traj_V1_18L['ng/m3'],   5)
P5_V2_18L   = np.percentile(Traj_V2_18L['ng/m3'],   5)
P5_V3_18ML  = np.percentile(Traj_V3_18ML['ng/m3'],  5)
P5_V3_18DL  = np.percentile(Traj_V3_18DL['ng/m3'],  5)

# Ocean
P5_V1_18O   = np.nan #np.percentile(Traj_V1_18O['ng/m3'],   5)
P5_V2_18O   = np.percentile(Traj_V2_18O['ng/m3'],   5)
P5_V3_18MO  = np.nan #np.percentile(Traj_V3_18MO['ng/m3'],  5)
P5_V3_18DO  = np.percentile(Traj_V3_18DO['ng/m3'],  5)
...
# Overall
P25_V1_18    = np.percentile(Traj_V1_18['ng/m3'],    25)
P25_V2_18    = np.percentile(Traj_V2_18['ng/m3'],    25)
P25_V3_18M   = np.percentile(Traj_V3_18M['ng/m3'],   25)
P25_V3_18D   = np.percentile(Traj_V3_18D['ng/m3'],   25)

# Sea Ice
P25_V1_18SI  = np.percentile(Traj_V1_18SI['ng/m3'],  25)
P25_V2_18SI  = np.percentile(Traj_V2_18SI['ng/m3'],  25)
P25_V3_18MSI = np.nan #np.percentile(Traj_V3_18MSI['ng/m3'], 25)
P25_V3_18DSI = np.percentile(Traj_V3_18DSI['ng/m3'], 25)

# Land
P25_V1_18L   = np.percentile(Traj_V1_18L['ng/m3'],   25)
P25_V2_18L   = np.percentile(Traj_V2_18L['ng/m3'],   25)
P25_V3_18ML  = np.percentile(Traj_V3_18ML['ng/m3'],  25)
P25_V3_18DL  = np.percentile(Traj_V3_18DL['ng/m3'],  25)

# Ocean
P25_V1_18O   = np.nan #np.percentile(Traj_V1_18O['ng/m3'],   25)
P25_V2_18O   = np.percentile(Traj_V2_18O['ng/m3'],   25)
P25_V3_18MO  = np.nan #np.percentile(Traj_V3_18MO['ng/m3'],  25)
P25_V3_18DO  = np.percentile(Traj_V3_18DO['ng/m3'],  25)
...
# Overall
P75_V1_18    = np.percentile(Traj_V1_18['ng/m3'],    75)
P75_V2_18    = np.percentile(Traj_V2_18['ng/m3'],    75)
P75_V3_18M   = np.percentile(Traj_V3_18M['ng/m3'],   75)
P75_V3_18D   = np.percentile(Traj_V3_18D['ng/m3'],   75)

# Sea Ice
P75_V1_18SI  = np.percentile(Traj_V1_18SI['ng/m3'],  75)
P75_V2_18SI  = np.percentile(Traj_V2_18SI['ng/m3'],  75)
P75_V3_18MSI = np.nan #np.percentile(Traj_V3_18MSI['ng/m3'], 75)
P75_V3_18DSI = np.percentile(Traj_V3_18DSI['ng/m3'], 75)

# Land
P75_V1_18L   = np.percentile(Traj_V1_18L['ng/m3'],   75)
P75_V2_18L   = np.percentile(Traj_V2_18L['ng/m3'],   75)
P75_V3_18ML  = np.percentile(Traj_V3_18ML['ng/m3'],  75)
P75_V3_18DL  = np.percentile(Traj_V3_18DL['ng/m3'],  75)

# Ocean
P75_V1_18O   = np.nan #np.percentile(Traj_V1_18O['ng/m3'],   75)
P75_V2_18O   = np.percentile(Traj_V2_18O['ng/m3'],   75)
P75_V3_18MO  = np.nan #np.percentile(Traj_V3_18MO['ng/m3'],  75)
P75_V3_18DO  = np.percentile(Traj_V3_18DO['ng/m3'],  75)
...
# Overall
P95_V1_18    = np.percentile(Traj_V1_18['ng/m3'],    95)
P95_V2_18    = np.percentile(Traj_V2_18['ng/m3'],    95)
P95_V3_18M   = np.percentile(Traj_V3_18M['ng/m3'],   95)
P95_V3_18D   = np.percentile(Traj_V3_18D['ng/m3'],   95)

# Sea Ice
P95_V1_18SI  = np.percentile(Traj_V1_18SI['ng/m3'],  95)
P95_V2_18SI  = np.percentile(Traj_V2_18SI['ng/m3'],  95)
P95_V3_18MSI = np.nan #np.percentile(Traj_V3_18MSI['ng/m3'], 95)
P95_V3_18DSI = np.percentile(Traj_V3_18DSI['ng/m3'], 95)

# Land
P95_V1_18L   = np.percentile(Traj_V1_18L['ng/m3'],   95)
P95_V2_18L   = np.percentile(Traj_V2_18L['ng/m3'],   95)
P95_V3_18ML  = np.percentile(Traj_V3_18ML['ng/m3'],  95)
P95_V3_18DL  = np.percentile(Traj_V3_18DL['ng/m3'],  95)

# Ocean
P95_V1_18O   = np.nan #np.percentile(Traj_V1_18O['ng/m3'],   95)
P95_V2_18O   = np.percentile(Traj_V2_18O['ng/m3'],   95)
P95_V3_18MO  = np.nan #np.percentile(Traj_V3_18MO['ng/m3'],  95)
P95_V3_18DO  = np.percentile(Traj_V3_18DO['ng/m3'],  95)
...
# Land & Sea Ice
WTstat_V1_18_L_SI,  WTpval_V1_18_L_SI  = stats.ttest_ind(Traj_V1_18L['ng/m3'],   Traj_V1_18SI['ng/m3'],  equal_var = False, nan_policy='omit')
WTstat_V2_18_L_SI,  WTpval_V2_18_L_SI  = stats.ttest_ind(Traj_V2_18L['ng/m3'],   Traj_V2_18SI['ng/m3'],  equal_var = False, nan_policy='omit')
WTstat_V3_18M_L_SI, WTpval_V3_18M_L_SI = stats.ttest_ind(Traj_V3_18ML['ng/m3'],  Traj_V3_18MSI['ng/m3'], equal_var = False, nan_policy='omit')
WTstat_V3_18D_L_SI, WTpval_V3_18D_L_SI = stats.ttest_ind(Traj_V3_18DL['ng/m3'],  Traj_V3_18DSI['ng/m3'], equal_var = False, nan_policy='omit')
WTstat_1819_L_SI,   WTpval_1819_L_SI   = stats.ttest_ind(Land_1819['ng/m3'],     SeaIce_1819['ng/m3'],   equal_var = False, nan_policy='omit')

# Land & Ocean
WTstat_V1_18_L_O,   WTpval_V1_18_L_O   = stats.ttest_ind(Traj_V1_18L['ng/m3'],   Traj_V1_18O['ng/m3'],   equal_var = False, nan_policy='omit')
WTstat_V2_18_L_O,   WTpval_V2_18_L_O   = stats.ttest_ind(Traj_V2_18L['ng/m3'],   Traj_V2_18O['ng/m3'],   equal_var = False, nan_policy='omit')
WTstat_V3_18M_L_O,  WTpval_V3_18M_L_O  = stats.ttest_ind(Traj_V3_18ML['ng/m3'],  Traj_V3_18MO['ng/m3'],  equal_var = False, nan_policy='omit')
WTstat_V3_18D_L_O,  WTpval_V3_18D_L_O  = stats.ttest_ind(Traj_V3_18DL['ng/m3'],  Traj_V3_18DO['ng/m3'],  equal_var = False, nan_policy='omit')
WTstat_1819_L_O,    WTpval_1819_L_O    = stats.ttest_ind(Land_1819['ng/m3'],     Ocean_1819['ng/m3'],    equal_var = False, nan_policy='omit')

# Sea Ice & Ocean
WTstat_V1_18_SI_O,  WTpval_V1_18_SI_O  = stats.ttest_ind(Traj_V1_18SI['ng/m3'],  Traj_V1_18O['ng/m3'],   equal_var = False, nan_policy='omit')
WTstat_V2_18_SI_O,  WTpval_V2_18_SI_O  = stats.ttest_ind(Traj_V2_18SI['ng/m3'],  Traj_V2_18O['ng/m3'],   equal_var = False, nan_policy='omit')
WTstat_V3_18M_SI_O, WTpval_V3_18M_SI_O = stats.ttest_ind(Traj_V3_18MSI['ng/m3'], Traj_V3_18MO['ng/m3'],  equal_var = False, nan_policy='omit')
WTstat_V3_18D_SI_O, WTpval_V3_18D_SI_O = stats.ttest_ind(Traj_V3_18DSI['ng/m3'], Traj_V3_18DO['ng/m3'],  equal_var = False, nan_policy='omit')
...
# Land & Sea Ice
KSstat_V1_18_L_SI,  KSpval_V1_18_L_SI  = stats.ks_2samp(Traj_V1_18L['ng/m3'],   Traj_V1_18SI['ng/m3'],  alternative='two-sided', mode='auto')
KSstat_V2_18_L_SI,  KSpval_V2_18_L_SI  = stats.ks_2samp(Traj_V2_18L['ng/m3'],   Traj_V2_18SI['ng/m3'],  alternative='two-sided', mode='auto')
KSstat_V3_18M_L_SI, KSpval_V3_18M_L_SI = np.nan, np.nan #stats.ks_2samp(Traj_V3_18ML['ng/m3'],  Traj_V3_18MSI['ng/m3'], alternative='two-sided', mode='auto')
KSstat_V3_18D_L_SI, KSpval_V3_18D_L_SI = stats.ks_2samp(Traj_V3_18DL['ng/m3'],  Traj_V3_18DSI['ng/m3'], alternative='two-sided', mode='auto')
KSstat_1819_L_SI,   KSpval_1819_L_SI   = stats.ks_2samp(Land_1819['ng/m3'],     SeaIce_1819['ng/m3'],   alternative='two-sided', mode='auto')

# Land & Ocean
KSstat_V1_18_L_O,   KSpval_V1_18_L_O   = np.nan, np.nan #stats.ks_2samp(Traj_V1_18L['ng/m3'],    Traj_V1_18O['ng/m3'],  alternative='two-sided', mode='auto')
KSstat_V2_18_L_O,   KSpval_V2_18_L_O   = stats.ks_2samp(Traj_V2_18L['ng/m3'],   Traj_V2_18O['ng/m3'],   alternative='two-sided', mode='auto')
KSstat_V3_18M_L_O,  KSpval_V3_18M_L_O  = np.nan, np.nan #stats.ks_2samp(Traj_V3_18ML['ng/m3'],   Traj_V3_18MO['ng/m3'], alternative='two-sided', mode='auto')
KSstat_V3_18D_L_O,  KSpval_V3_18D_L_O  = stats.ks_2samp(Traj_V3_18DL['ng/m3'],  Traj_V3_18DO['ng/m3'],  alternative='two-sided', mode='auto')
KSstat_1819_L_O,    KSpval_1819_L_O    = stats.ks_2samp(Land_1819['ng/m3'],     Ocean_1819['ng/m3'],    alternative='two-sided', mode='auto')

# Sea Ice & Ocean
KSstat_V1_18_SI_O,  KSpval_V1_18_SI_O  = np.nan, np.nan #stats.ks_2samp(Traj_V1_18SI['ng/m3'],  Traj_V1_18O['ng/m3'],   alternative='two-sided', mode='auto')
KSstat_V2_18_SI_O,  KSpval_V2_18_SI_O  = stats.ks_2samp(Traj_V2_18SI['ng/m3'],  Traj_V2_18O['ng/m3'],   alternative='two-sided', mode='auto')
KSstat_V3_18M_SI_O, KSpval_V3_18M_SI_O = np.nan, np.nan #stats.ks_2samp(Traj_V3_18MSI['ng/m3'], Traj_V3_18MO['ng/m3'],  alternative='two-sided', mode='auto')
KSstat_V3_18D_SI_O, KSpval_V3_18D_SI_O = stats.ks_2samp(Traj_V3_18DSI['ng/m3'], Traj_V3_18DO['ng/m3'],  alternative='two-sided', mode='auto')
...
# Land & Sea Ice
MWstat_V1_18_L_SI,  MWpval_V1_18_L_SI  = stats.mannwhitneyu(Traj_V1_18L['ng/m3'],   Traj_V1_18SI['ng/m3'],  alternative='two-sided')
MWstat_V2_18_L_SI,  MWpval_V2_18_L_SI  = stats.mannwhitneyu(Traj_V2_18L['ng/m3'],   Traj_V2_18SI['ng/m3'],  alternative='two-sided')
MWstat_V3_18M_L_SI, MWpval_V3_18M_L_SI = stats.mannwhitneyu(Traj_V3_18ML['ng/m3'],  Traj_V3_18MSI['ng/m3'], alternative='two-sided')
MWstat_V3_18D_L_SI, MWpval_V3_18D_L_SI = stats.mannwhitneyu(Traj_V3_18DL['ng/m3'],  Traj_V3_18DSI['ng/m3'], alternative='two-sided')
MWstat_1819_L_SI,   MWpval_1819_L_SI   = stats.mannwhitneyu(Land_1819['ng/m3'],     SeaIce_1819['ng/m3'],   alternative='two-sided')

# Land & Ocean
MWstat_V1_18_L_O,   MWpval_V1_18_L_O   = stats.mannwhitneyu(Traj_V1_18L['ng/m3'],   Traj_V1_18O['ng/m3'],   alternative='two-sided')
MWstat_V2_18_L_O,   MWpval_V2_18_L_O   = stats.mannwhitneyu(Traj_V2_18L['ng/m3'],   Traj_V2_18O['ng/m3'],   alternative='two-sided')
MWstat_V3_18M_L_O,  MWpval_V3_18M_L_O  = stats.mannwhitneyu(Traj_V3_18ML['ng/m3'],  Traj_V3_18MO['ng/m3'],  alternative='two-sided')
MWstat_V3_18D_L_O,  MWpval_V3_18D_L_O  = stats.mannwhitneyu(Traj_V3_18DL['ng/m3'],  Traj_V3_18DO['ng/m3'],  alternative='two-sided')
MWstat_1819_L_O,    MWpval_1819_L_O    = stats.mannwhitneyu(Land_1819['ng/m3'],     Ocean_1819['ng/m3'],    alternative='two-sided')

# Sea Ice & Ocean
MWstat_V1_18_SI_O,  MWpval_V1_18_SI_O  = stats.mannwhitneyu(Traj_V1_18SI['ng/m3'],  Traj_V1_18O['ng/m3'],   alternative='two-sided')
MWstat_V2_18_SI_O,  MWpval_V2_18_SI_O  = stats.mannwhitneyu(Traj_V2_18SI['ng/m3'],  Traj_V2_18O['ng/m3'],   alternative='two-sided')
MWstat_V3_18M_SI_O, MWpval_V3_18M_SI_O = stats.mannwhitneyu(Traj_V3_18MSI['ng/m3'], Traj_V3_18MO['ng/m3'],  alternative='two-sided')
MWstat_V3_18D_SI_O, MWpval_V3_18D_SI_O = stats.mannwhitneyu(Traj_V3_18DSI['ng/m3'], Traj_V3_18DO['ng/m3'],  alternative='two-sided')
...
# Land & Sea Ice
KWstat_V1_18_L_SI,  KWpval_V1_18_L_SI  = stats.kruskal(Traj_V1_18L['ng/m3'],   Traj_V1_18SI['ng/m3'])
KWstat_V2_18_L_SI,  KWpval_V2_18_L_SI  = stats.kruskal(Traj_V2_18L['ng/m3'],   Traj_V2_18SI['ng/m3'])
KWstat_V3_18M_L_SI, KWpval_V3_18M_L_SI = stats.kruskal(Traj_V3_18ML['ng/m3'],  Traj_V3_18MSI['ng/m3'])
KWstat_V3_18D_L_SI, KWpval_V3_18D_L_SI = stats.kruskal(Traj_V3_18DL['ng/m3'],  Traj_V3_18DSI['ng/m3'])
KWstat_1819_L_SI,   KWpval_1819_L_SI   = stats.kruskal(Land_1819['ng/m3'],     SeaIce_1819['ng/m3'])

# Land & Ocean
KWstat_V1_18_L_O,   KWpval_V1_18_L_O   = stats.kruskal(Traj_V1_18L['ng/m3'],   Traj_V1_18O['ng/m3'])
KWstat_V2_18_L_O,   KWpval_V2_18_L_O   = stats.kruskal(Traj_V2_18L['ng/m3'],   Traj_V2_18O['ng/m3'])
KWstat_V3_18M_L_O,  KWpval_V3_18M_L_O  = stats.kruskal(Traj_V3_18ML['ng/m3'],  Traj_V3_18MO['ng/m3'])
KWstat_V3_18D_L_O,  KWpval_V3_18D_L_O  = stats.kruskal(Traj_V3_18DL['ng/m3'],  Traj_V3_18DO['ng/m3'])
KWstat_1819_L_O,    KWpval_1819_L_O    = stats.kruskal(Land_1819['ng/m3'],     Ocean_1819['ng/m3'])

# Sea Ice & Ocean
KWstat_V1_18_SI_O,  KWpval_V1_18_SI_O  = stats.kruskal(Traj_V1_18SI['ng/m3'],  Traj_V1_18O['ng/m3'])
KWstat_V2_18_SI_O,  KWpval_V2_18_SI_O  = stats.kruskal(Traj_V2_18SI['ng/m3'],  Traj_V2_18O['ng/m3'])
KWstat_V3_18M_SI_O, KWpval_V3_18M_SI_O = stats.kruskal(Traj_V3_18MSI['ng/m3'], Traj_V3_18MO['ng/m3'])
KWstat_V3_18D_SI_O, KWpval_V3_18D_SI_O = stats.kruskal(Traj_V3_18DSI['ng/m3'], Traj_V3_18DO['ng/m3'])
