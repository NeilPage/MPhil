...
Hg0_V3_17 = pd.concat([Hg0_V3_17, SI_V3_17], axis=1, join='inner')

Hg0_V1_18 = pd.concat([Hg0_V1_18, SI_V1_18], axis=1, join='inner')
Hg0_V2_18 = pd.concat([Hg0_V2_18, SI_V2_18], axis=1, join='inner')
Hg0_V3_18 = pd.concat([Hg0_V3_18, SI_V3_18], axis=1, join='inner')
...
Filter        = Hg0_V3_17['Sea Ice Conc (0-1)'] > 0
Hg0_Ice_V3_17 = Hg0_V3_17[Filter]
...
Filter        = Hg0_V3_18['Sea Ice Conc (0-1)'] > 0
Hg0_Ice_V3_18 = Hg0_V3_18[Filter]
...
# Sea Ice
V1_17_Ice_Mean = np.mean(Hg0_Ice_V1_17['ng/m3'])
V2_17_Ice_Mean = np.mean(Hg0_Ice_V2_17['ng/m3'])
V3_17_Ice_Mean = np.mean(Hg0_Ice_V3_17['ng/m3'])

V1_18_Ice_Mean = np.mean(Hg0_Ice_V1_18['ng/m3'])
V2_18_Ice_Mean = np.mean(Hg0_Ice_V2_18['ng/m3'])
V3_18_Ice_Mean = np.mean(Hg0_Ice_V3_18['ng/m3'])

# Open Water
V1_17_OW_Mean = np.mean(Hg0_OW_V1_17['ng/m3'])
V2_17_OW_Mean = np.mean(Hg0_OW_V2_17['ng/m3'])
V3_17_OW_Mean = np.mean(Hg0_OW_V3_17['ng/m3'])

V1_18_OW_Mean = np.mean(Hg0_OW_V1_18['ng/m3'])
V2_18_OW_Mean = np.mean(Hg0_OW_V2_18['ng/m3'])
V3_18_OW_Mean = np.mean(Hg0_OW_V3_18['ng/m3'])
...
fig.legend(custom_lines, ['On Station', 'Off Station'], loc='upper left', bbox_to_anchor=(0.775, 0.275))
...
w = 0.01
n1 = math.ceil((Hg0_V1_17['ng/m3'].max()     - Hg0_V1_17['ng/m3'].min())/w)
n2 = math.ceil((Hg0_Ice_V1_17['ng/m3'].max() - Hg0_Ice_V1_17['ng/m3'].min())/w)
n3 = math.ceil((Hg0_OW_V1_17['ng/m3'].max()  - Hg0_OW_V1_17['ng/m3'].min())/w)

# Plot the variables
plt.hist(Hg0_Ice_V1_17['ng/m3'], density=True, bins=n2, histtype='step', edgecolor = 'red',   lw = 2.0, label='_nolegend_')
plt.hist(Hg0_OW_V1_17['ng/m3'],  density=True, bins=n3, histtype='step', edgecolor = 'green', lw = 2.0, label='_nolegend_')

# Plot the mean Hg
point1 = [V1_17_Ice_Mean, 0]
point2 = [V1_17_Ice_Mean, 0.2]
point3 = [V1_17_OW_Mean,  0]
point4 = [V1_17_OW_Mean,  0.2]
...
w = 0.01
n1 = math.ceil((Hg0_V2_17['ng/m3'].max()     - Hg0_V2_17['ng/m3'].min())/w)
n2 = math.ceil((Hg0_Ice_V2_17['ng/m3'].max() - Hg0_Ice_V2_17['ng/m3'].min())/w)
n3 = math.ceil((Hg0_OW_V2_17['ng/m3'].max()  - Hg0_OW_V2_17['ng/m3'].min())/w)
...
# Plot the mean Hg
point1 = [V2_17_Ice_Mean, 0]
point2 = [V2_17_Ice_Mean, 0.2]
point3 = [V2_17_OW_Mean,  0]
point4 = [V2_17_OW_Mean,  0.2]
...
w = 0.01
n1 = math.ceil((Hg0_V3_17['ng/m3'].max()     - Hg0_V3_17['ng/m3'].min())/w)
n2 = math.ceil((Hg0_Ice_V3_17['ng/m3'].max() - Hg0_Ice_V3_17['ng/m3'].min())/w)
n3 = math.ceil((Hg0_OW_V3_17['ng/m3'].max()  - Hg0_OW_V3_17['ng/m3'].min())/w)
...
# Plot the mean Hg
point1 = [V3_17_Ice_Mean, 0]
point2 = [V3_17_Ice_Mean, 0.2]
point3 = [V3_17_OW_Mean,  0]
point4 = [V3_17_OW_Mean,  0.2]
...
w = 0.01
n1 = math.ceil((Hg0_V1_18['ng/m3'].max()     - Hg0_V1_18['ng/m3'].min())/w)
n2 = math.ceil((Hg0_Ice_V1_18['ng/m3'].max() - Hg0_Ice_V1_18['ng/m3'].min())/w)
n3 = math.ceil((Hg0_OW_V1_18['ng/m3'].max()  - Hg0_OW_V1_18['ng/m3'].min())/w)
...
# Plot the mean Hg
point1 = [V1_18_Ice_Mean, 0]
point2 = [V1_18_Ice_Mean, 0.2]
point3 = [V1_18_OW_Mean,  0]
point4 = [V1_18_OW_Mean,  0.2]
...
w = 0.01
n1 = math.ceil((Hg0_V2_18['ng/m3'].max()     - Hg0_V2_18['ng/m3'].min())/w)
n2 = math.ceil((Hg0_Ice_V2_18['ng/m3'].max() - Hg0_Ice_V2_18['ng/m3'].min())/w)
n3 = math.ceil((Hg0_OW_V2_18['ng/m3'].max()  - Hg0_OW_V2_18['ng/m3'].min())/w)
...
# Plot the mean Hg
point1 = [V2_18_Ice_Mean, 0]
point2 = [V2_18_Ice_Mean, 0.2]
point3 = [V2_18_OW_Mean,  0]
point4 = [V2_18_OW_Mean,  0.2]
...
w = 0.01
n1 = math.ceil((Hg0_V3_18['ng/m3'].max()     - Hg0_V3_18['ng/m3'].min())/w)
n2 = math.ceil((Hg0_Ice_V3_18['ng/m3'].max() - Hg0_Ice_V3_18['ng/m3'].min())/w)
n3 = math.ceil((Hg0_OW_V3_18['ng/m3'].max()  - Hg0_OW_V3_18['ng/m3'].min())/w)
...
# Plot the mean Hg
point1 = [V3_18_Ice_Mean, 0]
point2 = [V3_18_Ice_Mean, 0.2]
point3 = [V3_18_OW_Mean,  0]
point4 = [V3_18_OW_Mean,  0.2]
